...
var SIDO_CODE = (function () {
  ...
  /* 옛 이름도 같은 코드로 셉니다(2026-09-08).
     ⚠️ 이름이 바뀌기 전에 들어온 제보는 **시트에 옛 이름으로 적혀 있습니다.**
        위 표만 고치면 그 제보들이 오류 없이 조용히 지도에서 빠집니다.
        행정구역 이름을 또 바꾸게 되면 여기에 옛 이름을 남겨 둘 것. */
  out['전라북도'] = '35';   // 2024-01-18 에 전북특별자치도로 바뀜
  out['강원도']   = '32';   // 2023-06-11 에 강원특별자치도로 바뀜
  return out;
})();
